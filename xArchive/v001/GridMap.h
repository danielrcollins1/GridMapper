...
class GridMap {
  ...
  protected:
    ...
    void paintCellFloor (HDC hDC, int x, int y, GridCell cell);
    void paintCellNWall (HDC hDC, int x, int y, GridCell cell);
    void paintCellWWall (HDC hDC, int x, int y, GridCell cell);
    void paintCellObject (HDC hDC, int x, int y, GridCell cell);
